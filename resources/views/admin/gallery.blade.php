...
@endsection
@section('description')
    Mengelola Konten di Menu Gallery Website
@endsection
@section('content')
<div class="row">
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class='content'>
                    <form action="{{url('/galleryadmin/creategallery')}}" class="dropzone" id='image-upload' files="true" method="POST" enctype="multipart/form-data" >
                    @csrf
                    </form>
...
<script>
    ...
    $(document).on('click','.hapus', function() {
        $('.delete-image').attr('action', "{{ url('galleryadmin/delete') }}/" + $(this).data('id'));
