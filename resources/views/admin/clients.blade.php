...
@endsection
@section('description')
    Mengelola Konten di Menu Clients Website
@endsection
@section('content')
<div class="row">
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab-{{$item->id}}" role="tabpanel">
                    <form action="{{url('/clients/update', $item->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf @method('patch')
                        ...
                        <div class="position-relative row form-group"><label for="company" class="col-sm-2 col-form-label">Company</label>
                            <div class="col-sm-10"><input name="company" id="company" placeholder="Entry Company"  class="form-control" value="{{$item->company}}" ></div>
                        </div>
    ...
    <div class="col-md-12">
        <div class="container">
            <a href="{{url('clientsadmin/create')}}" class="btn btn-success btn-lg btn-block mb-3"> Tambah </a>
        </div>
    </div>
</div>
@endsection